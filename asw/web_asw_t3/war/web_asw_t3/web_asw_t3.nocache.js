function web_asw_t3(){
  ...
  web_asw_t3.__sendStats = sendStats;
  web_asw_t3.__moduleName = $intern_4;
  web_asw_t3.__errFn = null;
  web_asw_t3.__moduleBase = $intern_6;
  web_asw_t3.__softPermutationId = $intern_7;
  web_asw_t3.__computePropValue = null;
  web_asw_t3.__getPropMap = null;
  web_asw_t3.__installRunAsyncCode = function(){
  }
  ;
  web_asw_t3.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  web_asw_t3.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  web_asw_t3.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  web_asw_t3.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[web_asw_t3.__softPermutationId];
  ...
  function installScript(filename){
    ...
    function installCode(code_0){
      ...
      script.src = code_0;
      if (web_asw_t3.__errFn) {
        script.onerror = function(){
          web_asw_t3.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  web_asw_t3.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  web_asw_t3.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    web_asw_t3.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return web_asw_t3.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    web_asw_t3.__getPropMap = function(){
      var result = {};
    ...
    ;
    web_asw_t3.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = web_asw_t3.__getPropMap;
    ...
    web_asw_t3.__softPermutationId = softPermutationId;
  ...
  processMetas();
  web_asw_t3.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = web_asw_t3.__moduleBase;
...
web_asw_t3.succeeded = web_asw_t3();
